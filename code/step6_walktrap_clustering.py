...
def run_walktrap(G):
    """
    Run Walktrap community detection via cdlib.
...
if __name__ == "__main__":
    ...
    with open(cluster_csv_path, "w", newline="", encoding="utf-8") as f:
        ...
        for year in sorted(year_graphs.keys()):
            G = year_graphs[year]
            print(f"Running Walktrap for year {year}...")
            partition = run_walktrap(G)
