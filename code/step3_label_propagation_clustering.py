# label_propagation_clustering.py
...
def run_label_propagation(G):
    """
    Run Label Propagation community detection using NetworkX.
...
if __name__ == "__main__":
    ...
    with open(cluster_csv_path, "w", newline="", encoding="utf-8") as f:
        ...
        for year in sorted(year_graphs.keys()):
            G = year_graphs[year]
            print(f"Running Label Propagation for year {year}...")
